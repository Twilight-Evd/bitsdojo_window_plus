...
typedef struct _BDWPublicAPI {
  ...
  TSetTitleBarHeight setTitleBarHeight;
  TIsPrimaryWindow isPrimaryWindow;
  TTerminateApp terminateApp;
  TSetWindowButtonVisibility setWindowButtonVisibility;
  TSetWindowButtonOffset setWindowButtonOffset;
} BDWPublicAPI;
