...
public:
  ...
  /// Get pending name for the window currently being created
  std::string GetPendingName();

  /// Get pending arguments for the window currently being created
  std::string GetPendingArguments();
...
private:
  ...
  /// Pending info for the window currently under construction
